...
def attach_onnx_metadata(env: ManagerBasedRLEnv, run_path: str, path: str, filename="policy.onnx") -> None:
    ...
    default_joint_pos_nominal = getattr(robot_data, "default_joint_pos_nominal", None)
    if default_joint_pos_nominal is None:
        # Fallback when startup DR term that creates `default_joint_pos_nominal` is disabled.
        default_joint_pos_nominal = robot_data.default_joint_pos[0]
